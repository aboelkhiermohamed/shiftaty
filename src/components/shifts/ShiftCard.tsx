...
import { Clock, Users, ChevronRight, Stethoscope, Trash2 } from "lucide-react";
...
export function ShiftCard({ shift, onClick, delay = 0 }: ShiftCardProps) {
  ...
  const handleEditNavigate = (e: React.MouseEvent) => {
    e.stopPropagation();
  ...
  return (
    ...
    >
      <div className="flex items-start justify-between">
        ...
        {/* Right side — earnings + chevron (tapping navigates to edit) */}
        <button
          onClick={handleEditNavigate}
          className="text-right flex flex-col items-end ml-2 touch-feedback"
        >
